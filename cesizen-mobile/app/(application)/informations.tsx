      ...
      <FlatList
              ...
              {types.length > 0 && (
                <FlatList
                  ...
                  renderItem={({ item }) => {
                    ...
                    const active = isAll ? selectedType === null : selectedType === item;
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptySubtitle}>Essayez de modifier votre recherche</Text>
          </View>
        }
        renderItem={({ item }) => {
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 32, fontWeight: '900', color: theme.colors.text, letterSpacing: -0.5 },
  searchWrapper: {
  ...
  resultsCount: { fontSize: 13, color: theme.colors.textMuted, marginBottom: 4 },
  card: {
    backgroundColor: theme.colors.surface, borderRadius: theme.radius.xl,
    marginHorizontal: theme.spacing.lg, overflow: 'hidden', ...theme.shadow.sm,
  },
  cardAccent: { height: 4 },
  ...
  typeBadge: { borderRadius: theme.radius.full, paddingHorizontal: 10, paddingVertical: 3 },
  ...
  cardExcerpt: { fontSize: 14, color: theme.colors.textSecondary, lineHeight: 20 },
