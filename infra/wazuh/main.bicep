...
@description('Ton adresse IP publique autorisée à accéder en SSH et au dashboard Wazuh (format CIDR, ex: 82.65.12.34/32)')
param allowedSourceIp string

@description('Préfixe DNS unique pour l IP publique')
...
@description('Taille de la VM (8 Go recommandé pour Wazuh)')
...
output wazuhDashboardUrl string = 'https://${publicIPAddress.properties.dnsSettings.fqdn}'
